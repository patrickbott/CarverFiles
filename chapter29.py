...
if __name__ == "__main__":
    ...
    (
        ...
        current_prices_dict,
        carry_prices_dict,
    ) = get_data_dict_with_carry(instrument_list=["us2", "us5", "us10"])

    multipliers = dict(us5=1000, us10=1000, us2=2000)
    risk_target_tau = 0.1
    fx_series_dict = create_fx_series_given_adjusted_prices_dict(adjusted_prices_dict)

    instrument_code_list = ["us5", "us2", "us10"]
    ratio_list = [-1, 1.5, 0.25]
    rv_instrument_name = "1.5US2/US5/0.25US10"
